...
const NEUTRAL = (labelMe, labelEn, value) => ({ label: { me: labelMe, en: labelEn }, value: { me: value, en: value }, neutral: true });
...
const F = {
  ...
  applicant: T('Podnosilac', 'Applicant', 'Nevladino udruženje „Santamore“ u osnivanju, [ulica i broj], Tivat, zastupano po predsjedavajućem Osnivačke skupštine [Ime i prezime], tel. [telefon], e-pošta [e-pošta]', 'Non-governmental association "Santamore" in formation, [street and number], Tivat, represented by the Chair of the Founding Assembly [Full name], tel. [phone], email [email]', { block: true }),
...
const form02 = { id: '02', title: { me: 'Odluka o osnivanju', en: 'Decision on founding' }, subtitle: { me: 'Osnivački akt po članu 11 Zakona o NVO', en: 'Founding act under Article 11 of the Law on NGOs' }, file: 'santamore-02-odluka-o-osnivanju',
  ...
  blocks: [
    ...
    { type: 'list', me: ['ime i prezime {{f1_name}}; JMB {{f1_jmb}}; adresa {{f1_addr}}; potpis {{sig}}', 'ime i prezime {{f2_name}}; JMB {{f2_jmb}}; adresa {{f2_addr}}; potpis {{sig}}', 'ime i prezime {{f3_name}}; JMB {{f3_jmb}}; adresa {{f3_addr}}; potpis {{sig}}'], en: ['full name {{f1_name}}; JMB {{f1_jmb}}; address {{f1_addr}}; signature {{sig}}', 'full name {{f2_name}}; JMB {{f2_jmb}}; address {{f2_addr}}; signature {{sig}}', 'full name {{f3_name}}; JMB {{f3_jmb}}; address {{f3_addr}}; signature {{sig}}'] },
...
const form05 = { id: '05', title: { me: 'Zapisnik sa osnivačke skupštine', en: 'Minutes of the founding assembly' }, subtitle: { me: 'Potpisuju zapisničar i predsjedavajući (čl. 25 Statuta)', en: 'Signed by the recorder and the chair (Statute Art. 25)' }, file: 'santamore-05-zapisnik-osnivacke-skupstine',
  ...
  blocks: [
    ...
    { type: 'list', me: ['{{f1_name}}', '{{f2_name}}', '{{f3_name}}'], en: ['{{f1_name}}', '{{f2_name}}', '{{f3_name}}'] },
    P('sazvao je Osnivačku skupštinu NEVLADINOG UDRUŽENJA „Santamore“ na dan {{date}} godine u Tivtu, sa početkom u {{start}} časova. Skupština je održana u Tivtu, u prostorijama na adresi {{venue}}. Skupštini su prisustvovali svi osnivači navedeni u Odluci o osnivanju i spisku osnivača: {{f1_name}}, {{f2_name}}, {{f3_name}}. Zapisničar: {{recorder}}.', 'convened the Founding Assembly of the NON-GOVERNMENTAL ASSOCIATION "Santamore" on {{date}} in Tivat, starting at {{start}}. The Assembly was held in Tivat, on the premises at {{venue}}. All the founders listed in the Decision on founding and in the list of founders attended: {{f1_name}}, {{f2_name}}, {{f3_name}}. Recorder: {{recorder}}.'),
...
function buildStatute() {
  ...
  for (let i = 0; i < me.length; i++) {
    ...
    if (t.startsWith('Dana, ')) { enQueue = enQueue.filter(q => !/^On \(date\)|^Chair of the Founding Assembly/.test(q)); flushEn(); blocks.push(SIG([{ me: 'Dana {{date}}, u Tivtu.', en: 'On {{date}}, in Tivat.', lbl: { me: 'datum i mjesto', en: 'date and place' } }, { me: 'Predsjedavajući Osnivačke Skupštine {{chair}} {{sig}} s.r.', en: 'Chair of the Founding Assembly {{chair}} {{sig}}', lbl: { me: 'potpis', en: 'signature' } }])); blocks.push(SIG([{ me: 'Osnivač {{f1_name}} {{sig}}', en: 'Founder {{f1_name}} {{sig}}', lbl: { me: 'potpis osnivača', en: 'founder\'s signature' } }, { me: 'Osnivač {{f2_name}} {{sig}}', en: 'Founder {{f2_name}} {{sig}}', lbl: { me: 'potpis osnivača', en: 'founder\'s signature' } }, { me: 'Osnivač {{f3_name}} {{sig}}', en: 'Founder {{f3_name}} {{sig}}', lbl: { me: 'potpis osnivača', en: 'founder\'s signature' } }])); break; }
...
const pack = { fields: F, forms, drafts, builtAt: new Date().toISOString().slice(0, 10) };
