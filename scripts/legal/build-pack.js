...
const F = {
  ...
  f2_name: T('Osnivač 2, ime i prezime', 'Founder 2, full name', '', '', { optional: true, neutral: true }), f2_jmb: NEUTRAL('Osnivač 2, JMB', 'Founder 2, JMB (13-digit personal ID number)', '', { optional: true }), f2_addr: T('Osnivač 2, adresa', 'Founder 2, address', '', '', { optional: true, neutral: true }),
  f3_name: T('Osnivač 3, ime i prezime', 'Founder 3, full name', '', '', { optional: true, neutral: true }), f3_jmb: NEUTRAL('Osnivač 3, JMB', 'Founder 3, JMB (13-digit personal ID number)', '', { optional: true }), f3_addr: T('Osnivač 3, adresa', 'Founder 3, address', '', '', { optional: true, neutral: true }),
  // Founders 2 to 5 are optional blanks: a founder's row appears once a name is typed. The Law asks for three founders; the print check says so.
  f4_name: T('Osnivač 4, ime i prezime', 'Founder 4, full name', '', '', { optional: true, neutral: true }), f4_jmb: NEUTRAL('Osnivač 4, JMB', 'Founder 4, JMB (13-digit personal ID number)', '', { optional: true }), f4_addr: T('Osnivač 4, adresa', 'Founder 4, address', '', '', { optional: true, neutral: true }),
  f5_name: T('Osnivač 5, ime i prezime', 'Founder 5, full name', '', '', { optional: true, neutral: true }), f5_jmb: NEUTRAL('Osnivač 5, JMB', 'Founder 5, JMB (13-digit personal ID number)', '', { optional: true }), f5_addr: T('Osnivač 5, adresa', 'Founder 5, address', '', '', { optional: true, neutral: true }),
...
for (const n of [1, 2, 3, 4, 5]) {
  HINTS[`f${n}_name`] = n === 1 ? ['Ime i prezime kao na ličnoj karti. Zakon traži najmanje tri osnivača; ostale dodajte dugmetom.', 'Full name as on the identity card. The Law asks for at least three founders; add the others with the button.'] : ['Ime i prezime kao na ličnoj karti.', 'Full name as on the identity card.'];
...
const form02 = { id: '02', title: { me: 'Odluka o osnivanju', en: 'Decision on founding' }, subtitle: { me: 'Osnivački akt po članu 11 Zakona o NVO', en: 'Founding act under Article 11 of the Law on NGOs' }, file: 'santamore-02-odluka-o-osnivanju',
  ...
  blocks: [
    ...
    { type: 'list', me: ['ime i prezime {{f1_name}}<br>JMB {{f1_jmb}}<br>adresa {{f1_addr}}<br>potpis {{sig}}', 'ime i prezime {{f2_name}}<br>JMB {{f2_jmb}}<br>adresa {{f2_addr}}<br>potpis {{sig}}', 'ime i prezime {{f3_name}}<br>JMB {{f3_jmb}}<br>adresa {{f3_addr}}<br>potpis {{sig}}', 'ime i prezime {{f4_name}}<br>JMB {{f4_jmb}}<br>adresa {{f4_addr}}<br>potpis {{sig}}', 'ime i prezime {{f5_name}}<br>JMB {{f5_jmb}}<br>adresa {{f5_addr}}<br>potpis {{sig}}'], en: ['full name {{f1_name}}<br>JMB {{f1_jmb}}<br>address {{f1_addr}}<br>signature {{sig}}', 'full name {{f2_name}}<br>JMB {{f2_jmb}}<br>address {{f2_addr}}<br>signature {{sig}}', 'full name {{f3_name}}<br>JMB {{f3_jmb}}<br>address {{f3_addr}}<br>signature {{sig}}', 'full name {{f4_name}}<br>JMB {{f4_jmb}}<br>address {{f4_addr}}<br>signature {{sig}}', 'full name {{f5_name}}<br>JMB {{f5_jmb}}<br>address {{f5_addr}}<br>signature {{sig}}'] },
    ...
    H3(7), P('Lice ovlašćeno za zastupanje i predstavljanje udruženja je {{rep_title}}:<br>ime i prezime {{rep_name}}<br>JMB {{rep_jmb}}<br>adresa {{rep_addr}}<br>potpis {{sig}}', 'The person authorised to represent the association and act on its behalf is the {{rep_title}}:<br>full name {{rep_name}}<br>JMB {{rep_jmb}}<br>address {{rep_addr}}<br>signature {{sig}}'),
