...
// enforcement. One row per calendar year, upserted in place. The report
// records what the ledger cannot (the story, and lists from before the
// ledger existed); it never overrides a derived figure.
