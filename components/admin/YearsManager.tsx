...
function YearForm({ row, onDone }: { row: YearRow; onDone: () => void }) {
  ...
  return (
    <form id="yearForm" onSubmit={submit}>
      ...
      <div className="sticky bottom-0 -mx-5 mt-6 flex flex-wrap items-center gap-x-4 gap-y-2 border-t-[0.5px] border-line bg-paper px-5 py-3 shadow-[0_-8px_24px_rgba(14,58,70,0.08)] sm:-mx-6 sm:px-6">
