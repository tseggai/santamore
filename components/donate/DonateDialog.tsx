      ...
      >
        <div className="relative flex max-h-[100dvh] w-full max-w-[600px] flex-col rounded-t-lg bg-paper shadow-[0_24px_60px_rgba(14,58,70,0.25)] sm:max-h-[calc(100dvh-2rem)] sm:rounded-lg">
          <button
            ...
            onClick={close}
            aria-label={t("close")}
            className="absolute right-3 top-3 z-10 flex h-9 w-9 items-center justify-center rounded-full bg-paper text-[19px] leading-none text-black/70 transition-colors hover:bg-mist-2 hover:text-sea"
          >
            ×
          </button>
