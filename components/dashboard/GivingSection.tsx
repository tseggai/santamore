 ...
 */
export async function GivingSection({ locale }: { locale: string }) {
  ...
  return (
    <section id="moje-davanje" className="mt-10 scroll-mt-6 border-t-[0.5px] border-line pt-8">
      <h2 className="type-display text-xl">{t("title")}</h2>
      <p className="mt-2 text-[14.5px] leading-relaxed text-black/65">
