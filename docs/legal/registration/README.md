...
Related governance drafts in `docs/legal/governance/`: `grants-criteria.md` (the beneficiary funding criteria under Article 38 of the statute additions), `chapter-rules.md` (the Chapter Rules under Article 43) `conflict-of-interest-policy.md` (the conflict of interest policy under Article 34, with the pay rules) and `child-safeguarding-policy.md` (the internal safeguarding policy behind the public page).
